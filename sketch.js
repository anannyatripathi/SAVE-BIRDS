...
function draw() {
  ...
  if(gameState==="about"){
    ...
    stroke("black");
    strokeWeight(2);
    text(" * My name is Anushka Tripathi.",20,150);
    text(" * My present age is 13.",20,200);
    text(" * This is my 48 project.",20,250);
    text(" * I have been inspired by the movie ROBOT 2.0 and by my father",20,300);
    text(" * My father daily keeps rice and water for the birds in two seperate bowls so that they won't ",20,350);
    text(" die due to food and water.",20,400);
